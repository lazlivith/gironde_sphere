...
export default function Detail({ item, onBack, onAdded }) {
  ...
  return (
    <div className="min-h-full w-full bg-[#F5F5F5] relative">
      ...
      {/* Sticky Bottom Bar */}
      <div className="sticky bottom-0 w-full flex items-center gap-3 bg-white px-5 py-4 shadow-[0_-10px_30px_rgba(0,0,0,0.06)] border-t border-gray-100 z-40">
